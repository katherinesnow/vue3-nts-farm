...
formCreate.install = function (Vue) {
    let that = this;
    Vue.prototype.$formCreate = function (rules,options, el = undefined) {
        formCreate.formCreateSetStyle();
        let fBuilder = new that(rules,options);
...
formCreate.prototype = {
    init(rules, options) {
        ...
        this.options = assign({}, formCreate.default.options, options);
        console.log('line 102 in Index',this.options);
