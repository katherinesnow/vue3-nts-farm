...
formCreateRender.prototype = {
    ...
    makeForm(VNodeFn) {
        let options = this.options, t = props.init().props({...options.formProps,...{ model: this.form.model, rules: this.form.rules }}).ref(options.form.ref)
                            ...
                            if (options.upload.handleRemove !== false || options.upload.handleView !== false)
                                container.push(this.cvm.make('div', { class: { 'form-upload-list-cover': true } }, ((img) => {
                                    ...
                                    if (options.upload.handleView !== false) {
                                        icon.push(this.cvm.icon({
                                            props: { type: 'ios-eye-outline' }, nativeOn: {
                                                'click': () => {
                                    ...
                                    if (options.upload.handleRemove !== false) {
                                        icon.push(this.cvm.icon({
                                            props: { type: 'ios-trash-outline' }, nativeOn: {
                                                'click': () => {
